...
#' @references A. Gelman, D.B. Rubin (1992), \emph{Inference from iterative simulation using multiple sequences}, Statistical Science 7(4):457-472. [\url{https://doi.org/10.1214/ss/1177011136}]
