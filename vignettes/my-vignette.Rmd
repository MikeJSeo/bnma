...
We have many features in addition to the general network model. One important addition to the network package that most packages don't have is the ability to add baseline risk. Please read Achana et al (2013) for more theoretical details. Below, we use their example on smoke alarm data. 
