...
We also added model to analyze contrast-level data insetad of arms-level data. Contrast level format uses treatment differences relative to the control arms. 
