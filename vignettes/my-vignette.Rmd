...
network <- with(certolizumab, network.data(Outcomes = Outcomes, Treat = Treat, Study = Study, N = N, response = "binomial", mean.A = meta.pla$TE.random, prec.A = 1/meta.pla$tau^2))
result <- network.run(network)
